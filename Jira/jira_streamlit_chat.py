...
JIRA_API_TOKEN_ENV = os.getenv("JIRA_API_TOKEN")
JIRA_USERNAME_ENV = os.getenv("JIRA_USERNAME")
JIRA_INSTANCE_URL_ENV = os.getenv("JIRA_INSTANCE_URL")
OPENAI_API_KEY_ENV = os.getenv("OPENAI_API_KEY")
JIRA_CLOUD_ENV = os.getenv("JIRA_CLOUD")
...
with st.sidebar:
    ...
    if "jira_api_token" not in st.session_state:
        st.session_state.jira_api_token = JIRA_API_TOKEN_ENV
    if "jira_username" not in st.session_state:
        st.session_state.jira_username = JIRA_USERNAME_ENV
    if "jira_instance_url" not in st.session_state:
        st.session_state.jira_instance_url = JIRA_INSTANCE_URL_ENV
    if "openai_api_key" not in st.session_state:
        st.session_state.openai_api_key = OPENAI_API_KEY_ENV
